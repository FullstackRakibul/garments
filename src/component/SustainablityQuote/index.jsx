...
class SustainablityQuote extends React.Component {
  render() {
    return (
      <Fragment>
        <Row className="sustainabilty-main-row">
          <Col className="sustainability-main-col" span={24}>
            <Row className="quote-row">
              <Col span={24}>
                <h2>
                  Explore Garments Ltd. started with the ambition to make
                  fashionable, quality and life-enhancing clothes for people.
                  See how we’re working to bring beautiful, consciously-crafted
                  fashion to everyone, everywhere.
                </h2>
              </Col>
            </Row>
            <Row className="gallery-row">
              <Col span={24} className="gallery-col">
                <Row>
                  <Col span={8}>
                    <img src={SA1} />
                  </Col>
            ...
            <Row className="explore-sustainability">
              <div class="box-1">
